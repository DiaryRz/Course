        ...
        <div class="card-body px-0 pt-0 pb-2">
            <div class="card z-index-0">
                <div class="card-header text-center pt-4">
                    <h5>Importation des points</h5>
                </div>
                    <form action="<?php echo base_url('ImportPointsController/importPoints'); ?>" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="name">Importer points:</label>
