                        ...
                        <?php foreach ($coureurs as $index => $coureur) { ?>
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="date" class="form-control" name="date" step="1" value="<?php echo set_value('date', $this->session->flashdata('date')[$index] ?? $datepardefaut); ?>">
                                </div>
                                <div class="col">
                                    <label for="temps_<?php echo $index; ?>">Heure d'arrivé:</label>
                                    <input type="time" class="form-control" name="temps" step="1" value="<?php echo set_value('temps', $this->session->flashdata('temps')[$index] ?? ''); ?>">
                                </div>
                            </div>
                        <?php } ?>
                        <div class="mb-3">
