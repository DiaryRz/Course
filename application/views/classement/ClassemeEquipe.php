            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-sm bg-gradient-success">
                                                <a href="<?php echo base_url("ClassementController/afficherdetails") ?>?idequipe=<?php echo $classement->idequipe ?>">Details par coureur</a>
                                            </span>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                    ...
                    <button class="btn bg-gradient-dark w-100 my-4 mb-2">
                        <a href="<?php echo base_url("ClassementController/ExporterPDF") ?>" style="color:white!important;">Generer PDF pour le gagnant</a>
                    </button>
                </div>
            </div>
